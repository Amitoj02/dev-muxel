@echo off
REM Launch DevLobby from the built output using Electron's own binary.
REM
REM This is the recommended way to run DevLobby day to day. It skips
...
if not exist "out\main\index.js" (
  echo Building DevLobby for the first time...
