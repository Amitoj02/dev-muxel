 ...
 *
 * Deliberately not a search box. GRID never touches the network on its own,
 ...
 *
 * The default one carries `GRID/1.0.0 Electron/43.4.1`, which some sites
